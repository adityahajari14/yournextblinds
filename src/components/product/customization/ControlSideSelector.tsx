...
interface ControlSideSelectorProps {
    options: ControlSideOption[];
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                {options.map((option) => (
                    <button
                        ...
                        className={`relative border-2 rounded-lg p-4 transition-all hover:border-[#00473c] text-center ${selectedSide === option.id
...
export default ControlSideSelector;
