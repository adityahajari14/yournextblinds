              ...
              <div className="flex flex-col gap-1 md:gap-2">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="flex items-end gap-1 md:gap-3">
                    <span className="text-base md:text-[21px] font-bold text-black">€ {product.price}</span>
                    {product.originalPrice > product.price && (
                      <span className="text-xs md:text-base text-[#474747] line-through">€ {product.originalPrice}</span>
                    )}
                  </div>
                </div>
                {/* Stars */}
