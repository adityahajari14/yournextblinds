...
export default function ProductCard({ product, className = '' }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Info */}
      <div className="bg-white pt-3 md:pt-4 pb-1 flex items-end justify-between gap-2 flex-1 min-h-0">
        ...
        <button 
          ...
          className="border border-black bg-white px-2.5 py-2.5 text-base text-black hover:bg-black hover:text-white transition-colors shrink-0 self-end"
        >
          Add to Cart
        </button>
      </div>
